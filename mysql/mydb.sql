...
-- -----------------------------------------------------
-- Table `sakila`.`usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`usuarios` (
...
-- -----------------------------------------------------
-- Table `sakila`.`sistema_pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`sistema_pago` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- Table `sakila`.`orden`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`orden` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `fecha` DATETIME NULL,
  `usuarios_id` INT NOT NULL,
  `usuarios_apellido` VARCHAR(45) NOT NULL,
  `usuarios_nombre` VARCHAR(45) NOT NULL,
  `sistema_pago_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_orden_usuarios1_idx` (`usuarios_id` ASC, `usuarios_apellido` ASC, `usuarios_nombre` ASC),
  INDEX `fk_orden_sistema_pago1_idx` (`sistema_pago_id` ASC),
  CONSTRAINT `fk_orden_usuarios1`
    FOREIGN KEY (`usuarios_id` , `usuarios_apellido` , `usuarios_nombre`)
    REFERENCES `sakila`.`usuarios` (`id` , `nombre` , `apellido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_sistema_pago1`
    FOREIGN KEY (`sistema_pago_id`)
    REFERENCES `sakila`.`sistema_pago` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`productos` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sakila`.`categoría`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`categoría` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sakila`.`producto_categoría_R`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`producto_categoría_R` (
  `productos_id` INT NOT NULL,
  `ctegoría_id` INT NOT NULL,
  INDEX `fk_table3_productos1_idx` (`productos_id` ASC),
  INDEX `fk_table3_ctegoría1_idx` (`ctegoría_id` ASC),
  CONSTRAINT `fk_table3_productos1`
    FOREIGN KEY (`productos_id`)
    REFERENCES `sakila`.`productos` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_table3_ctegoría1`
    FOREIGN KEY (`ctegoría_id`)
    REFERENCES `sakila`.`categoría` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sakila`.`orden_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`orden_producto` (
  `id` INT NOT NULL,
  `productos_id` INT NOT NULL AUTO_INCREMENT,
  `orden_id` INT NOT NULL,
  INDEX `fk_sistema de pago_productos1_idx` (`id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_sistema de pago_productos1`
    FOREIGN KEY (`id`)
    REFERENCES `sakila`.`productos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `sakila`.`perfil` (
  ...
  `usuarios_nombre` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_perfil_usuarios1_idx` (`usuarios_id` ASC, `usuarios_apellido` ASC, `usuarios_nombre` ASC),
...
-- -----------------------------------------------------
-- Table `sakila`.`lugar_orden`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`lugar_orden` (
  `id` INT NOT NULL AUTO_INCREMENT,
